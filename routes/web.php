...
use App\Http\Controllers\GeneralReservationController;
...
use App\Http\Controllers\GeneralTiketController;
...
Route::post('/warehouse/check-warehouse-detail/', [InvtWarehouseController::class, 'checkWarehouseDtl'])->name('check-warehouse-dtl');
...
Route::get('/sales-reservation',[SalesReservationController::class, 'index'])->name('sales-reservation');
Route::get('/sales-reservation/add', [SalesReservationController::class,'addSalesReservation'])->name('add-sales-reservation');
Route::post('/sales-reservation/add-elements', [SalesReservationController::class,'addElementsSalesReservation'])->name('add-elements-sales-reservation');
Route::post('/sales-reservation/process-add', [SalesReservationController::class, 'processAddSalesReservation'])->name('process-add-sales-reservation');
Route::get('/sales-reservation/reset-add',[SalesReservationController::class, 'resetSalesInvoice'])->name('add-reset-sales-reservation');
Route::post('/sales-reservation/add-array',[SalesReservationController::class,'addArraySalesReservation'])->name('add-array-sales-reservation');
Route::get('/sales-reservation/delete-array/{record_id}',[SalesReservationController::class,'deleteArraySalesReservation'])->name('delete-array-sales-reservation');
Route::get('/sales-reservation/detail/{sales_invoice_reservation_id}',[SalesReservationController::class, 'detailSalesReservation'])->name('detail-sales-reservation');
Route::get('/sales-reservation/delete/{sales_invoice_reservation_id}',[SalesReservationController::class, 'deleteSalesReservation'])->name('delete-sales-reservation');
Route::get('/sales-reservation/filter-reset',[SalesReservationController::class, 'filterResetSalesReservation'])->name('filter-reset-sales-reservation');
Route::post('/sales-reservation/filter',[SalesReservationController::class, 'filterSalesReservation'])->name('filter-sales-reservation');
...
Route::get('/cash-disbursement-report/export',[AcctDisbursementReportController::class, 'exportDisbursementReport'])->name('export-cash-disbursement-report');
 ...
 // aset type pages
    Route::prefix('aset-type')->name('aset-type.')->group(function () {
    Route::get('/', [AcctAssetTypeController::class, 'index'])->name('index');
    Route::get('/add', [AcctAssetTypeController::class, 'add'])->name('add');
    Route::post('/process-add', [AcctAssetTypeController::class, 'processAdd'])->name('process-add');
    Route::get('/edit/{asset_type_id}', [AcctAssetTypeController::class, 'edit'])->name('edit');
    Route::post('/process-edit', [AcctAssetTypeController::class, 'processEdit'])->name('process-edit');
    Route::get('/delete/{asset_type_id}', [AcctAssetTypeController::class, 'delete'])->name('delete');
    Route::post('/elements-add', [AcctAssetTypeController::class, 'elementsAdd'])->name('elements-add');
});
 // aset pages
 Route::prefix('aset')->name('aset.')->group(function () {
    Route::get('/', [AcctAssetController::class, 'index'])->name('index');
    Route::get('/add', [AcctAssetController::class, 'add'])->name('add');
...
Route::get('/reservation-payment/select-customer/{sales_invoice_reservation_id}', [PaymentReservationController::class, 'selectCustomerReservationPayment'])->name('select-customer-reservation-payment');
