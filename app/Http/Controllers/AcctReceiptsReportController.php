        ...
        foreach ($data as $key => $val) {
            $tblStock2 .="
                <tr>			
                    ...
                    <td style=\"text-align:left\">".$val['journal_voucher_date']."</td>
        ...
        if(count($data)>=0){
            ...
            foreach($data as $key=>$val){
                ...
                if(is_numeric($key)){
                    ...
                    $sheet->setCellValue('C'.$j, $val['journal_voucher_description']);
                    $sheet->setCellValue('D'.$j, $val['journal_voucher_date']);
                    $sheet->setCellValue('E'.$j, number_format($val['journal_voucher_amount'],2,'.',','));
                }
                $j++;
