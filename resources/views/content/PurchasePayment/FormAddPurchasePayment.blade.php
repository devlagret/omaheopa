...
@section('js')
    <script>
        ...
        function processAddArrayPurchasePaymentTransfer() {
            ...
            // console.log(bank_id);
            // console.log(payment_transfer_account_name);
            // console.log(payment_transfer_account_no);
            // console.log(payment_transfer_amount);
            $.ajax({
                type: "POST",
...
@section('content')
    ...
    <div class="card border border-dark">
        ...
        <form method="post" action="{{ route('purchase-payment.process-add') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" type="text" name="payment_total_cash_amount"
                                ...
                                onChange="elements_add(this.name, this.value);" style='text-align:right' />
                        </div>
                    </div>
                </div>
                <br />
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" type="hidden" style='text-align:right'
                                name="payment_amount" id="payment_amount" value="" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <tr>
                                ...
                                <td style='text-align  : center'>
                                    <input class="form-control" type="text" style='text-align:right'
                                        ...
                                        value="0" onChange="calculateAllocation()" />
                                </td>
                                <td style='text-align  : center'>
                                    <input class="form-control" type="text" style='text-align:right'
