                        ...
                        <?php
                            ...
                            echo "			
                                ...
                                if($val['report_type']	== 7){
                                    ...
                                    $grand_total_account_amount3	= 0;
                                    for($i = 0; $i < count($report_formula); $i++){
                                        if($report_operator[$i] == '-'){
                                            if($grand_total_account_amount3 == 0 ){
                                                $grand_total_account_amount3 = $grand_total_account_amount3 + $account_amount[$report_formula[$i]];
                                            } else {
                                                $grand_total_account_amount3 = $grand_total_account_amount3 - $account_amount[$report_formula[$i]];
                                            }
                                        } else if($report_operator[$i] == '+'){
                                    ...
                                    echo "
                                        <td><div style='font-weight:".$report_bold."'>".$report_tab."".$val['account_name']."</div></td>
                                        <td style='text-align:right'><div style='font-weight:".$report_bold."'>".number_format($grand_total_account_amount3, 2)."</div></td>
                                        ";
                                }
