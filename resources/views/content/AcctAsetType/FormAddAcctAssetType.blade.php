...
@section('content_header')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('aset-type.index') }}">Daftar Jenis Aset</a></li>
    ...
    <div class="card border border-dark">
        <div class="card-header border-dark bg-dark">
            ...
            <div class="float-right">
                <button onclick="location.href='{{ route('aset-type.index') }}'" name="Find" class="btn btn-sm btn-info"
        ...
        <form method="post" action="{{ route('aset-type.process-add') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade show active" id="aset-type">
