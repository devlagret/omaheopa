...
@endif
    ...
    <form method="post" action="{{ route('sales-room-facility.process-add') }}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
                    ...
                    <div class="row form-group mt-5">
                        <div class="col-md-6">
                            <div class="form-group">
                                <a class="text-dark">Nama Fasilitas<a class='red'> *</a></a>
                                <input class="form-control required input-bb" required name="facility_name"
                                        id="facility_name" type="text" autocomplete="off" placeholder="Masukan Nama Fasilitas"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input placeholder="Masukan Harga Fasilitas" required class="form-control input-bb required" name="facility_price_view" id="facility_price_view" type="text" autocomplete="off" value="{{old('facility_price',$sessiondata['facility_price']??'') }}" />
