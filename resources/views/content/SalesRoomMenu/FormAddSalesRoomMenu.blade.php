...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Tambah Menu Kamar</li>
    </ol>
  </nav>
...
@endif
    ...
    <form method="post" action="{{ route('sales-room-menu.process-add') }}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
                    ...
                    <div class="row form-group mt-5">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input placeholder="Masukan nama menu" autofocus="autofocus" required class="form-control input-bb required" name="room_menu_name" id="room_menu_name" type="text" autocomplete="off" onchange="function_elements_add(this.name, this.value)" value="{{old('room_menu_name',$sessiondata['room_menu_name']??'') }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="row form-group mt-5">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::select('room_menu_type', $tipemenu, $sessiondata['room_menu_type'] ?? '', [
                    ...
                    <div class="row form-group mt-5">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input placeholder="Masukan harga menu" required class="form-control input-bb required" name="room_menu_price_view" id="room_menu_price_view" type="text" autocomplete="off" value="{{old('room_menu_price',$sessiondata['room_menu_price']??'') }}" />
