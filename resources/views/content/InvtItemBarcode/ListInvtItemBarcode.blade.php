        ...
        <div class="card border border-dark">
            <div class="card-header border-dark bg-dark">
                <h5 class="mb-0 float-left">
                    Form Tambah Barcode {{ $item['item_name'] }}
                </h5>
            ...
            <form method="post" id="form-prevent" action="{{ route('item-barcode.process-add') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row form-group">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::select('item_unit_id', $unit, 0,['class' => 'form-control selection-search-clear select-form','name'=>'item_unit_id','id'=>'item_unit_id']) !!}  
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control input-bb" name="item_id" id="item_id" type="text" autocomplete="off" value="{{ $item['item_id'] }}" hidden/>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a type="button" class="btn btn-outline-danger btn-sm" href="{{ route('item-barcode.delete',['item_id'=>$row->item_id,'item_barcode_id'=>$row['item_barcode_id']]) }}">Hapus</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
