...
@section('content_header')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Tambah ssBarang</li>
        </ol>
    </nav>
        ...
        <form method="post" action="{{ route('process-add-item') }}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link {{ $items['kemasan'] == 1 ? 'active' : '' }}" href="#barang" role="tab"
                            data-toggle="tab">Data Barang</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ $items['kemasan'] > 1 ? 'active' : '' }}" href="#form-kemasan" role="tab"
                            data-toggle="tab">Kemasan</a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade {{ $items['kemasan'] == 1 ? 'show active' : '' }}"
                        id="barang">
                        ...
                        <div class="row form-group mt-5">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class=" required selection-search-clear select-form"
                                        placeholder="Masukan Kategori" name="item_category_id" id="item_category_id" onchange="function_elements_add(this.name, this.value)">
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control required input-bb" name="item_code" id="item_code"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control required input-bb" name="item_name" id="item_name"
                                        type="text" autocomplete="off"
                                        onchange="function_elements_add(this.name, this.value)"
                                ...
                                <div class="input-kemasan" id="input-kemasan-{{ $x }}">
                                    @if ($x != 1)
                                        <a class="float-right text-body" data-toggle="tooltip" data-placement="top"
                                            title="Hapus Kemasan" onclick="removeKemasan('input-kemasan-{{$x}}')"><i
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <a class="text-dark">Satuan Barang {{ $x }}<a class='red'>
                                                        *</a></a>
                                                {!! Form::select('item_unit_id', $itemunits, $items['kemasan[' . ($x - 1) . '][item_unit_id]'] ?? 0, [
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control input-bb required" required
                                                    ...
                                                    autocomplete="off"
                                                    onchange="function_elements_add(this.name, this.value)"
                                                    value="{{ $items['kemasan[' . ($x - 1) . '][item_default_quantity]'] ?? '' }}" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control input-bb required" required
                                                    ...
                                                    autocomplete="off"
                                                    onchange="function_elements_add(this.name, this.value)"
                                                    value="{{ $items['kemasan[' . ($x - 1) . '][item_unit_price]'] ?? '' }}" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control input-bb required" required
                                                    ...
                                                    onchange="function_elements_add(this.name, this.value)"
                                                    value="{{ $items['kemasan[' . ($x - 1) . '][item_unit_cost]'] ?? '' }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
