            ...
            <div class="row form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control input-bb" name="purchase_return_supplier" id="purchase_return_supplier"
                            type="text" autocomplete="off" value="{{ $acctassetItem['asset_depreciation_item_accumulation_amount'] }}" readonly />
                    </div>
                </div>
            </div>
            <h5 class="mb-0 float-left">
            ...
            <div class="row form-group">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control input-bb" name="purchase_return_supplier" id="purchase_return_supplier"
                            type="date" autocomplete="off" value="" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover table-full-width">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                {!! Form::select('account_id_debit',  $acctaccount,  ['class' => 'selection-search-clear select-form', 'id' => 'account_id_debit', 'onchange' => 'elements_add(this.name , this.value);']) !!}
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                {!! Form::select('account_id_credit',  $acctaccount,  ['class' => 'selection-search-clear select-form', 'id' => 'account_id_credit', 'onchange' => 'elements_add(this.name , this.value);']) !!}
                            </td>
                            <td></td>
                            <td>
