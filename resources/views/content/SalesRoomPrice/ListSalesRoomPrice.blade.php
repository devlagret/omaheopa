            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ empty($row->room_price_start_date)?'-':date('d-m-Y',strtotime($row->room_price_start_date)) }}</td>
                        <td>{{ empty($row->room_price_start_date)?'-':date('d-m-Y',strtotime($row->room_price_end_date)) }}</td>
