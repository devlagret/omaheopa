...
@endif 
<div id="accordion">
    <form  method="post" action="{{ route('filter-sales-tiket') }}" enctype="multipart/form-data">
    @csrf
...
<div class="card border border-dark">
  <div class="card-header bg-dark clearfix">
    ...
    <div class="form-actions float-right">
        <button onclick="location.href='{{ url('/sales-tiket/add') }}'" name="Find" class="btn btn-sm btn-info" title="Add Data"><i class="fa fa-plus"></i> Tambah Penjualan</button>
    </div>
  </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a type="button" class="btn btn-outline-warning btn-sm" href="{{ url('/sales-tiket/detail/'.$row['sales_invoice_id'] ?? '') }}">Detail</a>
                            <a type="button" class="btn btn-outline-danger btn-sm" href="{{ url('/sales-tiket/delete/'.$row['sales_invoice_id'] ?? '' ) }}">Hapus</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
