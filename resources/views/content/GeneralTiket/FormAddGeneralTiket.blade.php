...
@section('content_header')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ url('general-ticket') }}">Daftar Tiket Umum</a></li>
            <li class="breadcrumb-item active" aria-current="page">Tambah Tiket Umum</li>
        </ol>
    </nav>
...
@section('content')
    ...
    <div class="card border border-dark">
        ...
        <form method="post" id="form-barang" action="{{ route('process-add-tiket') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
