...
@section('content')
    ...
    @endif
    <div id="label-msg" class="alert alert-warning" role="alert">
        <i class="fa fa-exclamation"></i> &nbsp; Gudang Sudah Ada
    </div>
        ...
        <form method="post" action="{{ route('process-add-warehouse') }}" enctype="multipart/form-data">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" name="warehouse_code" id="warehouse_code" type="text"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" name="warehouse_name" id="warehouse_name" type="text"
                                autocomplete="off" onchange="function_elements_add(this.name, this.value)"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" name="warehouse_phone" id="warehouse_phone" type="text"
                                autocomplete="off" onchange="function_elements_add(this.name, this.value)"
                                value="{{ $warehouses['warehouse_phone'] ?? '' }}" />
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
                            <a class="text-dark">Alamat<a class='red'> *</a></a>
                            <textarea class="form-control input-bb" name="warehouse_address" id="warehouse_address" type="text"
                                autocomplete="off" onchange="function_elements_add(this.name, this.value)">{{ $warehouses['warehouse_address'] ?? '' }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-footer text-muted">
                <div class="form-actions float-right">
                    ...
                    <button type="submit" name="Save" id="btn-save" class="btn btn-primary" title="Save"><i
