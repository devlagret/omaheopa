...
@section('js')
    <script>
        ...
        function count_total() {
            ...
            var subtotal_room_old = $("#sbs-room-old").val();
            ...
            sbsAll = Number(subtotal_room_old) + Number(subtotal_facility) + Number(subtotal_menu);
            dis_ori = (sbsAll * dicount_ori) / 100;
            sbsAll -= dis_ori
            sbsAll -= down_payment
            sbsAll += Number(subtotal_room)-Number(subtotal_room_old)
        ...
        $(document).ready(function() {
            ...
            $("#save-btn").click(function (e) { 
                e.preventDefault();
                if($('#checkout_date').val()==$('#checkout_date_old').val()){
                    alert('Tanggal Belum Diubah, Harap Ubah Tanggal');
                }else{
                    $(this).prop('disabled',true);
                    check('{{ $data->sales_order_id }}');
                }
            });
        });
    </script>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <h5 class="col">
                                Subtotal : Rp
                                {{ number_format(is_null($data->invoice->extend_price) ? (empty($data->discount) ? $data->sales_order_price : ($data->sales_order_price / (100 - $data->discount)) * 100) : (empty($data->invoice->extend_discount) ? $data->invoice->extend_price : ($data->invoice->extend_price / (100 - $data->invoice->extend_discount)) * 100), 2) }}
                            </h5>
                        </div>
                        <div class="row">
                            <h5 class="col">
                        ...
                        @isset($data->invoice->extend_price)
                            <div class="row">
                                <h5 class="col">
                                    Diperpanjang Sebanyak : {{ $data->extend->groupBy('checkout_date_new')->get()->count() }}
                                    Kali
                                </h5>
                            </div>
                        @endisset
                            ...
                            <div class="card border border-dark mt-4" id="card-total-all">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col">
                                            <div class="col form-group form-md-line-input" id="date-out">
                                                ...
                                                <input type="date"
                                                    ...
                                                    data-date-format="dd-mm-yyyy" name="checkout_date" id="checkout_date"
                                                    min="{{ $data->checkout_date }}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-8">
                                            <input class="form-control input-bb" type="text" readonly
                                                id="subtotal_all_view" name="subtotal_all_view" autocomplete="off" />
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-8">
                                            <input type="number" min="0" max="100"
                                                ...
                                                value="{{ $data->invoice->extend_discount ?? 0 }}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-8">
                                            <input type="text" class="form-control input-bb" id="discount_amount_view"
                                                name="discount_amount_view" autocomplete="off" />
                                    ...
                                    <div class="row form-actions float-right">
                                        <button type="reset" name="Reset" class="btn btn-danger mr-2"
                                            autocomplete="off" id="form-reset"><i class="fa fa-times"></i> Batal</button>
                                        <button type="button" id="save-btn" class="btn btn-success button-prevent"
                                            title="Simpan"><i class="fa fa-check"></i> Simpan</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td colspan="2" class="font-weight-bold text-center fs-4">
                                                ...
                                                <input type="hidden" name="sbs-room" id="sbs-room" value="0"
                                                    />
                                                <input type="hidden" name="sbs-room-old" id="sbs-room-old"
                                                    value="{{ $total }}" />
                                            </td>
                                        </tr>
                                    </tfoot>
