...
<h3 class="page-title">
    <b>Daftar Kamar</b> <small>Kelola Bangunan </small>
</h3>
<br/>
...
<div class="card border border-dark">
  <div class="card-header bg-dark clearfix">
    ...
    <div class="form-actions float-right">
        <button onclick="location.href='{{ route('room-type.add') }}'" name="add" class="btn btn-sm btn-info" title="Add Data"><i class="fa fa-plus"></i> Tambah Bangunan </button>
    </div>
  </div>
