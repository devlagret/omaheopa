...
@endif
    ...
    <form method="post" action="{{ route('room-type.process-add') }}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
                    ...
                    <div class="row form-group mt-5">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input placeholder="Masukan tipe kamar" required class="form-control input-bb required" name="room_type_name" id="room_type_name" type="text" autocomplete="off" onchange="function_elements_add(this.name, this.value)" value="{{old('room_type_name',$sessiondata['room_type_name']??'') }}"/>
                            </div>
                        </div>
                    </div>
                </div>
